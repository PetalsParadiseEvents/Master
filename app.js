...
function renderNavbar() {
    ...
    nav.innerHTML = `
        ...
        <div class="nav-links">
            ...
            <a href="builder.html" class="nav-link" style="color: #d4af37; font-weight: 700;">✨ DIY Studio</a>
        ...
        <div class="mobile-menu" id="mobile-menu" role="dialog" aria-modal="true" aria-label="Mobile navigation">
            ...
            <a href="#" class="nav-link">Home</a>
            <a href="builder.html" class="nav-link" style="color: #d4af37; font-weight: 700;">✨ DIY Decor Studio (Visualizer)</a>
                    ...
                    ${(() => {
                        ...
                        <div style="background: rgba(0,106,255,0.06); border: 1.5px solid #006aff; border-radius: 12px; padding: 1.2rem; margin-top: 1rem; text-align: center;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 1.2rem;">
                                <div style="padding: 10px; background: #FFFFFF; border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 10px; box-shadow: var(--shadow-sm); text-align: center;">
