                ...
                <div style="background: var(--bg-color); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.5rem; margin-bottom: 1.5rem; box-shadow: var(--shadow-sm);">
                    ...
                    <div style="background: rgba(212,175,55,0.05); border: 1px solid rgba(212,175,55,0.2); border-radius: 10px; padding: 1rem; margin-top: 1rem;">
                        ...
                        <div style="border-top: 1px dashed var(--border-color); padding-top: 0.6rem; font-size: 0.88rem; display: flex; flex-direction: column; gap: 0.25rem;">
                            ...
                            ${(parseFloat(order.discount || 0) > 0 || (order.promo_code && order.promo_code.trim() !== '')) ? `<div style="display: flex; justify-content: space-between; color: #10b981;"><span>Coupon / Discount ${order.promo_code ? `(${escapeHtml(order.promo_code)})` : ''}:</span> <span>-$${parseFloat(order.discount || 0).toFixed(2)}</span></div>` : ''}
                    ...
                    ${(() => {
                        ...
                        <div style="background: rgba(0,106,255,0.06); border: 1.5px solid #006aff; border-radius: 12px; padding: 1.2rem; margin-top: 1rem; text-align: center;">
                            ...
                            <p style="font-size: 0.85rem; color: var(--text-secondary); margin: 0 0 0.8rem 0;">
                                Securely complete your payment online using Credit Card, Debit Card, or Apple Pay.
                            </p>

                            <div style="background: rgba(0,106,255,0.08); border: 1px solid rgba(0,106,255,0.25); border-radius: 10px; padding: 10px 14px; margin-bottom: 1rem; text-align: left; font-size: 0.88rem; max-width: 380px; margin-left: auto; margin-right: auto;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 3px; color: var(--text-secondary);">
                                    <span>Base Order Estimate:</span>
                            ...
                            <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 1.2rem;">
                                <div style="padding: 10px; background: #FFFFFF; border: 1px solid rgba(0, 0, 0, 0.1); border-radius: 10px; box-shadow: var(--shadow-sm);">
                                    <a target="_blank" data-url="https://square.link/u/xV2eBBtG?src=embd" href="https://square.link/u/xV2eBBtG?src=embed" onclick="showCheckoutWindow(event, this)" style="display: inline-block; font-size: 17px; line-height: 48px; height: 48px; color: #ffffff !important; min-width: 210px; background-color: #006aff; text-align: center; box-shadow: 0 0 0 1px rgba(0,0,0,.1) inset; border-radius: 6px; text-decoration: none; font-weight: 600;">Pay now ($` + finalOnlineTotal + `)</a>
                                </div>
                                <div style="background: #ffffff; padding: 8px; border-radius: 10px; border: 1px solid #cbd5e1; text-align: center;">
                                    <img src="data:image/png;base64," onerror="this.onerror=null; this.src='/square-qr-code.png';" alt="Scan Official Square QR Code to Pay" style="width: 130px; height: 130px; display: block; border-radius: 6px;" />
